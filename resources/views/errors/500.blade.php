    ...
    <div class="min-h-[50vh] flex items-center justify-center text-white">
        <section class="flex flex-col md:flex-row items-center gap-6 md:gap-10 px-6">
            ...
            <div class="space-y-4 text-center md:text-left">
                <h2 class="text-2xl md:text-3xl font-semibold font-mono">Server Error</h2>
                <p class="text-zinc-400 max-w-md">
                    You do not have permission to access this page.
                </p>
                <div>
                    <button onclick="window.location.reload()" class="flex items-center gap-2 px-4 py-2 border border-zinc-700 rounded-md hover:bg-zinc-800 transition">
