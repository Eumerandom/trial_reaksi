...
$classes = Flux::classes()
    ->add('shrink-0 size-4.5 rounded-[.3rem] flex justify-center items-center')
...
<div {{ $attributes->class($classes) }} data-flux-checkbox-indicator>
    <flux:icon.check variant="micro" class="hidden text-(--color-accent-foreground)" />
    <flux:icon.minus variant="micro" class="hidden text-(--color-accent-foreground)" />
</div>
