        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-16 p-6 sm:p-8 bg-white dark:bg-zinc-800 rounded-lg shadow-md text-center transform transition duration-700 ease-in-out" 
                ...
                <div class="mt-8 mb-12 text-center">
                    <p class="mb-4 text-sm text-gray-600 dark:text-gray-400">Ikuti kami:</p>
                    <div class="flex flex-row justify-center items-center space-x-4">
                        <a href="https://linktr.ee/reksi.id" target="_blank" rel="noopener noreferrer"
                           class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-center text-green-700 dark:text-green-300 bg-green-500/50 border border-green-500 rounded-lg hover:bg-green-500/75 focus:ring-4 focus:ring-green-300/50 dark:focus:ring-green-800/50 transition duration-150 ease-in-out">
                        ...
                        <a href="https://www.instagram.com/rekomendasibebasafiliasi/" target="_blank" rel="noopener noreferrer"
                           class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-center text-pink-700 dark:text-pink-300 bg-pink-500/50 border border-pink-500 rounded-lg hover:bg-pink-500/75 focus:ring-4 focus:ring-pink-300/50 dark:focus:ring-pink-800/50 transition duration-150 ease-in-out">
